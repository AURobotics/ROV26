...
Rectangle {
    ...
    Column {
        ...
        Text {
            id: depthLabel
            text: root.depth.toFixed(1) + "m"
            font.pixelSize: 14
            font.bold: true
            color: (palette.window.hsvValue > 0.5) ? "#222222" : "white"
    ...
    Rectangle {
        ...
        // Anchored to the visual depthView within the column
        anchors.centerIn: parent
        anchors.verticalCenterOffset: -((depthLabel.height + 5) / 2)
